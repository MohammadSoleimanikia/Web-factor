// app/features/purchase-invoices/components/CreatePurchaseInvoiceForm.tsx
...
import { useCreatePurchaseInvoice } from "../hooks/useCreatePurchaseInvoice";
import {
...
export default function CreatePurchaseInvoiceForm() {
    ...
    const onSubmit = async (data: PurchaseInvoiceFormType) => {
        try {
            await createInvoice(normalizePurchaseInvoicePayload(data));
            navigate("/purchase-invoices");
        } catch (error) {
            console.error(error);
            toast.error("خطا در ثبت فاکتور خرید");
        }
    };
        ...
        return (
            <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">
                    کالایی برای ثبت فاکتور خرید ندارید
                </h3>

                <p className="text-muted-foreground max-w-sm mb-6">
                    لطفاً ابتدا کالاهای خود را اضافه کنید، سپس فاکتور خرید ثبت
                    نمایید.
                </p>
